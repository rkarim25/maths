...
export const MATHS_FUN = {
  1: [
    ...
    { kind: 'trick', emoji: '🤝', title: 'Turn-around facts', text: '2 + 5 is the same as 5 + 2. Swapping the numbers gives the same answer — so you only have to learn half of them!' },
  ...
  2: [
    ...
    { kind: 'trick', emoji: '🔄', title: 'Near doubles', text: 'Know 6 + 6 = 12? Then 6 + 7 is just one more = 13. Use the doubles you know to get the ones you don’t.' },
  ...
  3: [
    ...
    { kind: 'trick', emoji: '➗', title: 'Halving to divide', text: 'Dividing by 2 is just halving. Dividing by 4? Halve it, then halve again. 36 ÷ 4 → 18 → 9.' },
  ...
  4: [
    ...
    { kind: 'trick', emoji: '9️⃣', title: 'Multiply by 9 fast', text: 'To × 9, multiply by 10 and subtract the number. 9 × 7 = 70 − 7 = 63.' },
